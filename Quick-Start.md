...
This quick guide show you how to easily upload the code to your board module using the TinyGS uploader, in one click, and available for the following OS :

* Linux:  [TinyGS_Uploader_LINUX](https://github.com/G4lile0/tinyGS/releases/download/untagged-ae9b69d538edac8ea65b/TinyGS_Uploader_LINUX)
* MAC:    [TinyGS_Uploader_MAC.zip](https://github.com/G4lile0/tinyGS/releases/download/untagged-ae9b69d538edac8ea65b/TinyGS_Uploader_MAC.zip)
* Win 10: [TinyGS_Uploader_WINDOWS.exe](https://github.com/G4lile0/tinyGS/releases/download/untagged-ae9b69d538edac8ea65b/TinyGS_Uploader_WINDOWS.exe)
